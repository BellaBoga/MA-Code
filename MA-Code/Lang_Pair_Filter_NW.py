...
df = pd.read_csv('/home/bella/Dropbox/Master-Thesis/MA_Thesis_Program/final_nw_off_diag_iranian.csv',header=0)
...
for i in range(len(langs3)):
    for j in range(len(langs4)):
            ...
            mean_value.to_csv("/home/bella/Dropbox/Master-Thesis/MA_Thesis_Program/Iranian/Mean_Values_Off_Diag_NW/"+langs3[i]+"_"+langs4[j]+".csv")
