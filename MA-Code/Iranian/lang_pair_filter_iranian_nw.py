...
df = pd.read_csv('/home/bella/Dropbox/Master-Thesis/MA_Thesis_Program/iranian_nw.csv',header=0)
...
for i in range(len(langs3)):
    for j in range(len(langs4)):
            ...
            new_dataframe=df[df["L2"].str.match(langs3[i]) & df["L1"].str.match(langs4[j])]
            ...
            mean_value.to_csv("/home/bella/Dropbox/Master-Thesis/MA_Thesis_Program/Iranian/Mean_Values_Iranian_NW/"+langs3[i]+"_"+langs4[j]+".csv")
